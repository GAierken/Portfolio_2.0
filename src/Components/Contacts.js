 ...
 const Contacts = () => {
    ...
    return (
        <div style={{marginTop: '50px', marginBottom: '50px'}}>
            ...
            <Popup style={popupStyle} inverted size='mini' content='Medium' trigger={<Icon style={{color: '#efbbff'}}  link size="huge" name='medium' onClick={() => {window.open('https://medium.com/@g.aierken')}}/>}/>
            ...
            <Popup style={popupStyle} inverted size='mini' content='Résumé' trigger={<Icon style={{color: '#efbbff'}} link size="huge" name='file alternate' onClick={() => {window.open(Resume)}}/>}/>
